...
<html lang="ka">
   	<head>
		...
		<link href="{{ asset('static/css/main.f97a3a14.chunk.css') }}" rel="stylesheet">
    </head>
    <body>
        <noscript>
